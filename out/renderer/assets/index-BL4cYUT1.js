import { R as React, r as reactExports, j as jsxRuntimeExports, e as formatLocalDate, g as formatCollapsedMonth, h as formatMonth, i as isWeekend, k as formatDayNumber, l as formatCollapsedDate, m as motion, n as formatTimeOfDay, f as formatDuration, d as formatClock, o as formatSince, p as formatLongDate, q as commonjsGlobal, t as getDefaultExportFromCjs, v as formatHourOfDay, c as createRoot } from "./format-B09i810A.js";
import { A as AnimatePresence, R as Ring } from "./Ring-DOsfr5Cg.js";
...
function initThreadStore() {
  window.thread.invoke["threads:list"](void 0).then((threads) => {
...
async function loadDay(localDate2) {
  const day = await window.thread.invoke["day:get"]({ localDate: localDate2 });
  useDayStore.getState().setViewed(day, localDate2);
}
const useCarryStore = create(() => ({
  todos: [],
  blockers: [],
  loaded: false
}));
async function refreshCarry() {
  const { todos, blockers } = await window.thread.invoke["carry:list"](void 0);
  useCarryStore.setState({ todos, blockers, loaded: true });
}
async function initCarryStore() {
  await refreshCarry();
...
async function initSessionStore() {
  const state = await window.thread.invoke["session:state"](void 0);
...
function SideRail() {
  ...
  const years = reactExports.useMemo(
    () => groupByYear(dates.filter((date2) => date2 !== todayDate)),
    [dates, todayDate]
  );
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, overflowY: "auto", padding: "0 8px" }, children: [
          !collapsed && years.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              style: {
                fontSize: 11,
              ...
              children: "Past pages appear here once you’ve used them. Days you didn’t work are never created."
            }
          ) : null,
          years.map((year) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 6 }, children: [
            !collapsed ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
            ...
            year.months.map((month) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 10 }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: collapsed ? formatCollapsedMonth(month.key) : formatMonth(month.key)
                }
              ),
              month.days.map((date2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                DayRow,
                {
                  date: date2,
                  collapsed,
                  selected: viewedDate === date2,
                  onOpen: () => {
                    setTab("today");
                    void loadDay(date2);
                  }
...
function DayRow({
  ...
  const weekend = isWeekend(date2);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      onClick: onOpen,
      title: weekend ? `${date2} · weekend` : date2,
      style: {
        display: "flex",
        alignItems: "center",
        gap: 8,
      ...
      children: !collapsed ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        weekend ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--amber)", fontSize: 11 }, children: "★" }) : null
...
function StartupToggle({ collapsed }) {
  const [enabled, setEnabled] = reactExports.useState(null);
  reactExports.useEffect(() => {
    void window.thread.invoke["startup:get"](void 0).then(setEnabled);
  }, []);
  if (enabled === null || collapsed) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      onClick: () => void window.thread.invoke["startup:set"]({ enabled: !enabled }).then(setEnabled),
...
function groupByYear(dates) {
  ...
  for (const date2 of [...dates].sort().reverse()) {
    const year = date2.slice(0, 4);
    const month = date2.slice(0, 7);
    const months = years.get(year) ?? /* @__PURE__ */ new Map();
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h1",
            {
              style: {
                ...
                background: "linear-gradient(100deg, var(--text) 55%, color-mix(in srgb, var(--amber) 65%, var(--text)))",
...
function useIpcEvent(channel, handler) {
  const ref = reactExports.useRef(handler);
  ref.current = handler;
  reactExports.useEffect(() => window.thread.on(channel, (payload) => ref.current(payload)), [channel]);
}
function useLiveClock(sessionId) {
...
const button = "_button_1gtog_1";
const sm = "_sm_1gtog_18";
const md = "_md_1gtog_23";
const primary = "_primary_1gtog_28";
const ghost$1 = "_ghost_1gtog_47";
const danger$1 = "_danger_1gtog_58";
const styles$2 = {
  button,
  sm,
  md,
...
function Button({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      className: [styles$2.button, styles$2[variant], styles$2[size], className].filter(Boolean).join(" "),
      ...rest,
      children: [
        icon,
        children ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children }) : null
      ]
    }
  );
}
...
const chip = "_chip_fn8vf_1";
const amber = "_amber_fn8vf_14";
const slate = "_slate_fn8vf_17";
const moss = "_moss_fn8vf_20";
const lavender = "_lavender_fn8vf_23";
const danger = "_danger_fn8vf_26";
const emerald = "_emerald_fn8vf_29";
const clay = "_clay_fn8vf_32";
const pulse = "_pulse_fn8vf_36";
const styles$1 = {
  chip,
  amber,
  slate,
...
function StatusChip({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "span",
    {
      className: `${styles$1.chip} ${styles$1[meta.tone]} ${status === "in_progress" ? styles$1.pulse : ""}`,
      children: [
...
const OPTIONS = ["in_progress", "blocked", "waiting", "done", "dormant"];
function StatusDropdown({
  status,
  onChange
}) {
  const [open, setOpen] = reactExports.useState(false);
  const [promptWaiting, setPromptWaiting] = reactExports.useState(false);
  const [pendingStatus, setPendingStatus] = reactExports.useState("waiting");
  const [waitingText, setWaitingText] = reactExports.useState("");
  const pick = (next) => {
    setOpen(false);
  ...
  if (promptWaiting) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        ...
        value: waitingText,
        onChange: (e3) => setWaitingText(e3.target.value),
        onKeyDown: (e3) => {
          if (e3.key === "Enter") {
          ...
          if (e3.key === "Escape") setPromptWaiting(false);
        },
        onBlur: () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative" }, children: [
    ...
    open ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { position: "fixed", inset: 0, zIndex: 9 }, onClick: () => setOpen(false) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          style: {
          ...
          children: OPTIONS.map((option) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(StatusChip, { status: option })
            },
            option
          ))
        }
...
function NextAction({ thread }) {
  const [adding, setAdding] = reactExports.useState(false);
  const [text, setText] = reactExports.useState("");
  const next = [...thread.steps].sort((a2, b2) => a2.order - b2.order).find((s2) => !s2.done);
  if (next) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 11, color: "var(--text-muted)", marginTop: 2, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }, children: next.text });
  }
  if (adding) {
    const submit = async () => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        ...
        onKeyDown: (e3) => e3.key === "Enter" && void submit(),
        onBlur: () => void submit(),
...
function LinkChip({
  ...
  const [text, setText] = reactExports.useState(link ?? "");
  const commit = () => {
    setEditing(false);
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "aria-hidden": "true", style: { fontWeight: 700 }, children: notion ? "N" : "🌐" }),
              linkLabel(link)
            ]
          }
        ),
...
function ThreadCard({
  ...
  const [title2, setTitle] = reactExports.useState(thread.title);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      className: expanded ? void 0 : "lift",
      style: {
        display: "flex",
        alignItems: "center",
        gap: 14,
        ...
        background: expanded ? "var(--surface-raised)" : `color-mix(in srgb, ${tone} ${hover ? 12 : 7}%, var(--surface))`,
        opacity: isDragging ? 0.5 : 1,
        cursor: "pointer",
        transition: "background var(--motion-fast) var(--ease-out), border-color var(--motion-fast) var(--ease-out), box-shadow 260ms ease-in-out",
        boxShadow: inProgress ? `0 0 0 1px color-mix(in srgb, ${tone} 22%, transparent), var(--shadow-card), var(--edge-light)` : "var(--shadow-card), var(--edge-light)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [
              ...
              children: [
                editingTitle ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    ...
                    onKeyDown: (e3) => {
                      if (e3.key === "Enter") void commitTitle();
                      if (e3.key === "Escape") {
                        setTitle(thread.title);
                        setEditingTitle(false);
                      }
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  {
                    link: thread.link,
                    onChange: (link) => void window.thread.invoke["threads:update"]({
                      id: thread.id,
                      patch: { link: link ?? "" }
                    })
                  }
          ...
          (thread.status === "waiting" || thread.status === "blocked") && thread.waitingOn ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: 11, color: tone, marginTop: 2 }, children: [
...
const root$a = "_root_1okao_1";
const title = "_title_1okao_11";
const detail = "_detail_1okao_17";
const styles = {
  root: root$a,
  title,
  detail
...
function EmptyState({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.root, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: styles.title, children: title2 }),
    detail2 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: styles.detail, children: detail2 }) : null,
    action2
  ] });
}
function Checkbox({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      ...
      style: {
        ...
        background: checked ? tone : hover && !disabled ? "color-mix(in srgb, var(--line-strong) 30%, transparent)" : "var(--ink)",
        boxShadow: hover && !disabled && !checked ? `0 0 0 3px color-mix(in srgb, ${tone} 15%, transparent)` : "none",
...
function Checklist({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    sorted.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(Progress, { done: doneCount, total: sorted.length }) : null,
...
function Progress({ done, total }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 10 }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: 11, color: "var(--text-faint)", marginTop: 4 }, children: [
      done,
      "/",
      total,
      " done"
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Checkbox,
          {
            ...
            onChange: () => void window.thread.invoke["steps:toggle"]({
              threadId,
              stepId: step.id
            })
          }
        ...
        editing ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ...
            onKeyDown: (e3) => {
              if (e3.key === "Enter") void commit(true);
              if (e3.key === "Escape") {
                setText(step.text);
                setEditing(false);
              }
...
function SessionHistory({ sessions }) {
  if (sessions.length === 0) return /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { title: "No sessions logged yet." });
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: sessions.map((session) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      style: {
        display: "flex",
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mono", children: formatDuration(session.activeMs) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--text-faint)" }, children: session.distractions.length > 0 ? `${session.distractions.length} distraction${session.distractions.length === 1 ? "" : "s"}` : "—" })
      ]
    },
    session.id
  )) });
...
function ThreadDetail({ thread, onClose }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "20px 28px 60px", maxWidth: 760, margin: "0 auto" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: onClose,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 12, marginBottom: 6 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          value: title2,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 10, marginBottom: 20 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatusChip, { status: thread.status }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { style: { marginBottom: 28 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel$1, { children: "Steps" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Checklist, { threadId: thread.id, steps: thread.steps })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { style: { marginBottom: 28 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel$1, { children: "Notes" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "textarea",
        {
          value: notes,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel$1, { children: "Sessions" }),
...
function DoneSection() {
  ...
  if (openId) {
    ...
    if (thread) return /* @__PURE__ */ jsxRuntimeExports.jsx(ThreadDetail, { thread, onClose: () => setOpenId(null) });
  }
  const groups = groupByDate$1(threads);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: 32 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Collapsible,
    {
      title: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        "Done ",
        loaded ? `(${threads.length}${hasMore ? "+" : ""})` : ""
      ] }),
      defaultOpen: false,
      children: !loaded ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          onClick: () => void load(),
      ...
      ) : threads.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { title: "Nothing completed yet." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { paddingBottom: 12 }, children: [
        groups.map((group) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 14 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 11, color: "var(--text-faint)", marginBottom: 6 }, children: formatLocalDate(group.date) }),
          group.threads.map((thread) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
...
function groupByDate$1(threads) {
  const map2 = /* @__PURE__ */ new Map();
  for (const thread of threads) {
    const date2 = thread.completedLocalDate ?? "unknown";
    const list = map2.get(date2);
    if (list) list.push(thread);
    else map2.set(date2, [thread]);
  }
  return [...map2.entries()].sort((a2, b2) => a2[0] < b2[0] ? 1 : -1).map(([date2, list]) => ({ date: date2, threads: list }));
}
function ThreadDrawer({
  ...
  const tone = statusColor(thread.status);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { initial: false, children: open ? /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(DrawerLabel, { children: "Checklist" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Checklist, { threadId: thread.id, steps: thread.steps }),
...
function ThreadsView() {
  ...
  const active = reactExports.useMemo(
    () => boardOrder(threads.filter((t2) => t2.status !== "done" && t2.status !== "dormant")),
    [threads]
  );
  const dormant = reactExports.useMemo(
    () => boardOrder(threads.filter((t2) => t2.status === "dormant")),
    [threads]
  );
  ...
  const dragProps = (list, thread, index) => ({
    ...
    onDrop: (event) => {
      ...
      void move(dragId, index, list === dormant ? "dormant" : void 0);
    },
    onDragEnd: () => {
      setDragId(null);
      setDropTarget(null);
  ...
  const renderCard = (list, thread, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ThreadCard,
      {
        thread,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ThreadDrawer, { thread, open: expandedId === thread.id })
  ] }, thread.id);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "20px 28px 40px", maxWidth: 920, margin: "0 auto" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      PageHeader,
      {
        ...
        right: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 14 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "span",
            {
          ...
          pickJustStart(threads) ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
    ...
    error ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: 12, color: "var(--clay)", margin: "0 0 12px" }, children: error }) : null,
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        style: {
        ...
        children: [
          active.length === 0 && !creating ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            EmptyState,
            {
          ...
          ) : active.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              onClick: () => setCreating(true),
              disabled: full,
              title: full ? `At most ${ACTIVE_THREAD_CAP} active threads. Finish one, or move one to the dormant zone.` : void 0,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: 26 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Collapsible,
      {
        title: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          "Dormant (",
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: dormant.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "p",
              {
                style: {
                  fontSize: 12,
                ...
                children: [
                  "Drag a thread here to park it. Dormant threads don’t count toward the ",
                  ACTIVE_THREAD_CAP,
                  "."
                ]
              }
...
function boardOrder(threads) {
  return [...threads].sort((a2, b2) => {
    if (a2.order !== void 0 && b2.order !== void 0) return a2.order - b2.order;
    if (a2.order !== void 0) return -1;
    if (b2.order !== void 0) return 1;
...
function pickJustStart(threads) {
  const board = boardOrder(
    threads.filter((t2) => t2.status !== "done" && t2.status !== "dormant")
  );
  return board.find((t2) => t2.status === "in_progress" || t2.status === "idle") ?? board[0] ?? null;
}
async function justStart(threads) {
...
function NowSection({
  ...
  const [text, setText] = reactExports.useState(day?.now ?? "");
  ...
  const commit = () => {
    ...
    void window.thread.invoke["day:setNow"]({ now: text, localDate: localDate2 });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      className: state ? "breath" : void 0,
      style: {
        borderRadius: 16,
        border: "1px solid var(--line)",
        borderLeft: "3px solid var(--amber)",
        background: "linear-gradient(135deg, color-mix(in srgb, var(--amber) 11%, var(--surface)), color-mix(in srgb, var(--coral) 5%, var(--surface)))",
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ...
            onChange: (e3) => setText(e3.target.value),
            onBlur: commit,
            onKeyDown: (e3) => e3.key === "Enter" && commit(),
            style: {
              width: "100%",
              fontSize: 26,
              fontWeight: 600,
        ...
        !state && pick ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
              display: "flex",
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { fontSize: 12, color: "var(--text-muted)" }, children: [
                "25 minutes on ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "var(--text)" }, children: pick.title }),
                " — no choosing, just go."
              ] })
            ]
          }
        ) : null,
        state ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
              display: "flex",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Ring, { value: tick?.progress ?? 0, size: 38, dim: state.paused, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mono", style: { fontSize: 9 }, children: formatClock(remaining) }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                ...
                state.nextAction ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 11, color: "var(--text-muted)" }, children: state.nextAction }) : null
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
...
function TodayThreads({ readOnly }) {
  const threads = useThreadStore((s2) => s2.threads);
  const setTab = useUiStore((s2) => s2.setTab);
  const active = reactExports.useMemo(
    () => boardOrder(
  ...
  const setDone = async (thread, done) => {
    await window.thread.invoke["threads:setStatus"]({
      id: thread.id,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Panel,
    {
      ...
      children: active.length === 0 && doneToday.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        EmptyState,
        {
        ...
        active.map((thread) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Row$1,
          {
            thread,
            done: false,
        ...
        doneToday.map((thread) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Row$1,
          {
            thread,
            done: true,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              ...
              next && !done ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  style: {
                    display: "block",
...
function PromoteToThread({ localDate: localDate2, todoId }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      onClick: () => void window.thread.invoke["todo:promote"]({ localDate: localDate2, todoId }),
...
function TodoList({ localDate: localDate2 }) {
  const todos = useCarryStore((s2) => s2.todos);
  const [text, setText] = reactExports.useState("");
  const add2 = async () => {
    const trimmed = text.trim();
    setText("");
    if (trimmed) await window.thread.invoke["todo:add"]({ text: trimmed, localDate: localDate2 });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Panel,
    {
      ...
      children: [
        todos.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { title: "Nothing outstanding.", detail: "A clean list is allowed to stay clean." }) : todos.map((todo) => /* @__PURE__ */ jsxRuntimeExports.jsx(TodoItem, { todo }, todo.id)),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
...
function TodoItem({ todo }) {
  ...
  const [hover, setHover] = reactExports.useState(false);
  const localDate2 = todo.localDate;
  const commit = async () => {
    setEditing(false);
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Checkbox,
          {
            ...
            onChange: () => void window.thread.invoke["todo:toggle"]({
              localDate: localDate2,
              todoId: todo.id
            })
          }
        ...
        editing ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ...
            onChange: (e3) => setText(e3.target.value),
            onBlur: () => void commit(),
            onKeyDown: (e3) => e3.key === "Enter" && void commit(),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            ...
            children: formatSince(todo.localDate)
          }
        ),
        hover && !editing ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(PromoteToThread, { localDate: localDate2, todoId: todo.id }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
...
function BlockerList({ localDate: localDate2 }) {
  const blockers = useCarryStore((s2) => s2.blockers);
  const [text, setText] = reactExports.useState("");
  const add2 = async () => {
    const trimmed = text.trim();
    setText("");
    if (trimmed) await window.thread.invoke["blocker:add"]({ text: trimmed, localDate: localDate2 });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Panel,
    {
      ...
      children: [
        blockers.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { title: "Nothing blocked." }) : blockers.map((blocker) => /* @__PURE__ */ jsxRuntimeExports.jsx(BlockerItem, { blocker }, blocker.id)),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--clay)", fontSize: 11, flexShrink: 0 }, children: "■" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  value: text,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Checkbox,
          {
            ...
            onChange: () => void window.thread.invoke["blocker:resolve"]({
              localDate: blocker.localDate,
              blockerId: blocker.id
            })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { flex: 1, fontSize: 13 }, children: blocker.text }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            style: { fontSize: 10, color: "var(--text-faint)", flexShrink: 0 },
            title: `Raised ${blocker.localDate}`,
            children: formatSince(blocker.localDate)
          }
        ),
        hover ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: () => void window.thread.invoke["blocker:remove"]({
              localDate: blocker.localDate,
              blockerId: blocker.id
            }),
...
function LogSection({
  ...
  const [text, setText] = reactExports.useState("");
  const entries = [...day?.log ?? []].sort((a2, b2) => a2.at.localeCompare(b2.at));
  const add2 = async () => {
    const trimmed = text.trim();
    setText("");
    if (trimmed) await window.thread.invoke["log:add"]({ text: trimmed, localDate: localDate2 });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Panel,
    {
      ...
      warm: true,
      right: entries.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "span",
        {
          className: "mono",
      ...
      children: [
        ...
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 2 }, children: entries.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { entry }, entry.id)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mono", style: { fontSize: 11, color: "var(--text-faint)" }, children: "now" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  value: text,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            ...
            children: formatTimeOfDay(entry.at)
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { flex: 1, fontSize: 13 }, children: entry.text }),
        hover ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: () => void window.thread.invoke["log:remove"]({
...
function ThoughtList({ day, readOnly }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: thoughts.map((thought) => /* @__PURE__ */ jsxRuntimeExports.jsx(ThoughtRow, { localDate: day.localDate, thought, readOnly }, thought.id)) });
}
function ThoughtRow({
  localDate: localDate2,
  thought,
  ...
  const [open, setOpen] = reactExports.useState(false);
  const process = async (action2) => {
    setOpen(false);
    await window.thread.invoke["thought:process"]({ localDate: localDate2, thoughtId: thought.id, action: action2 });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "space-between", gap: 8 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: thought.text }),
          !readOnly && !thought.processed ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: () => setOpen((v2) => !v2),
        ...
        open ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 8, marginTop: 6 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => void process("thread"), style: linkBtn, children: "→ thread" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => void process("todo"), style: linkBtn, children: "→ todo" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => void process("dismiss"), style: linkBtn, children: "dismiss" })
        ] }) : null
      ]
    }
  );
...
function ThoughtCapture({ day, localDate: localDate2 }) {
  const [text, setText] = reactExports.useState("");
  const setTab = useUiStore((s2) => s2.setTab);
  const add2 = async () => {
    const trimmed = text.trim();
    setText("");
    if (trimmed) await window.thread.invoke["thought:add"]({ text: trimmed, localDate: localDate2 });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Panel,
    {
      ...
      children: [
        ...
        !day || day.thoughts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { title: "Nothing parked.", detail: "This is a parking lot, not a to-do list." }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ThoughtList, { day, readOnly: false })
      ]
    }
  );
}
function TodayView() {
  ...
  const localDate2 = isPast ? viewedDate : todayDate;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "20px 28px 40px", maxWidth: 820, margin: "0 auto" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      PageHeader,
      {
        title: isPast ? formatLongDate(localDate2) : "Today",
        description: isPast ? "Anything you add here is filed under this day. To-dos and blockers show where they stand now." : "What you are on right now, and what the day turns into."
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 18 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(NowSection, { day, localDate: localDate2 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TodayThreads, { readOnly: false }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TodoList, { localDate: localDate2 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(BlockerList, { localDate: localDate2 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LogSection, { day, localDate: localDate2 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ThoughtCapture, { day, localDate: localDate2 })
    ] })
  ] });
}
const SCOPES = [
...
function ScopeToggle({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", border: "1px solid var(--line)", borderRadius: 10, padding: 2 }, children: SCOPES.map((option) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
...
function Surface(props) {
  var children = props.children, width = props.width, height = props.height, viewBox = props.viewBox, className = props.className, style = props.style, title2 = props.title, desc = props.desc, others = _objectWithoutProperties$f(props, _excluded$f);
  var svgView = viewBox || {
    width,
    height,
    x: 0,
  ...
  var CategoricalChartWrapper = /* @__PURE__ */ function(_Component) {
    ...
    return _createClass(CategoricalChartWrapper2, [{
      ...
      value: function render() {
        ...
        var _this$props6 = this.props, children = _this$props6.children, className = _this$props6.className, width = _this$props6.width, height = _this$props6.height, style = _this$props6.style, compact = _this$props6.compact, title2 = _this$props6.title, desc = _this$props6.desc, others = _objectWithoutProperties(_this$props6, _excluded2);
...
function TrendChart({ trend }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { height: 140 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(LineChart, { data: trend, margin: { top: 4, right: 8, bottom: 0, left: -20 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      XAxis,
      {
        dataKey: "label",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { domain: [0, 100], tick: { fontSize: 10, fill: "var(--text-faint)" }, axisLine: false, tickLine: false, width: 28 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Tooltip,
      {
        contentStyle: {
...
function InsightCard({ insight }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 14 }, children: insight.headline }),
        insight.detail ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 12, color: "var(--text-muted)", marginTop: 4 }, children: insight.detail }) : null
      ]
    }
  );
}
function DistractionSection({ stats }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: 8 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 11, color: "var(--text-faint)", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: 10 }, children: "Attention" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12, marginBottom: 16 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(MiniStat, { label: "Per focused hour", value: stats.perFocusedHour.toFixed(1) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          onClick: () => setTab("park"),
    ...
    stats.internal + stats.external > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: 12, color: "var(--text-muted)", marginBottom: 12 }, children: [
      stats.internal,
      " internal · ",
      stats.external,
      " external",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { height: 100 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data, margin: { top: 4, right: 0, bottom: 0, left: 0 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "hour", tick: false, axisLine: { stroke: "var(--line)" }, tickLine: false }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Tooltip,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "count", fill: "var(--slate)", radius: [3, 3, 0, 0], isAnimationActive: false })
    ] }) }) }),
    stats.suggestedSessionMs !== null ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { fontSize: 11, color: "var(--text-faint)", marginTop: 8 }, children: [
      "Sessions around ",
      formatDuration(stats.suggestedSessionMs),
      " might fit your focus better — just a suggestion."
    ] }) : null
  ] });
}
...
function DetailSection({
  ...
  const busiest = detail2.peakStartHour;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 24 }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(StatTile, { label: "Steps completed", value: String(detail2.stepsCompleted) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatTile,
            {
              label: "Average block",
              value: detail2.avgSessionMs > 0 ? formatDuration(detail2.avgSessionMs) : "—"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatTile,
            {
              label: "Longest block",
              value: detail2.longestSessionMs > 0 ? formatDuration(detail2.longestSessionMs) : "—"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatTile,
    ...
    detail2.hourStarts.some((count) => count > 0) ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, { children: "When you start" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(HourStrip, { hours: detail2.hourStarts, peak: busiest })
    ] }) : null,
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, { children: "All time" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        style: {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(StatTile, { label: "Days worked", value: String(detail2.allTime.daysWorked) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(StatTile, { label: "Focus logged", value: formatDuration(detail2.allTime.focusMs) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatTile,
            {
              label: "Threads finished",
              value: String(detail2.allTime.threadsCompleted)
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatTile,
            {
              ...
              value: detail2.allTime.bestDayFocusMs > 0 ? formatDuration(detail2.allTime.bestDayFocusMs) : "—"
            }
          )
        ]
      }
...
function HourStrip({
  ...
  const max2 = Math.max(...hours, 1);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 20 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", alignItems: "flex-end", gap: 2, height: 56 }, children: hours.map((count, hour) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        title: `${formatHourOfDay(hour)} — ${count} start${count === 1 ? "" : "s"}`,
        style: {
          flex: 1,
          height: `${Math.max(2, count / max2 * 100)}%`,
          borderRadius: 2,
...
function ActiveDays({ active, window: window2 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: 11, color: "var(--text-faint)", marginTop: 8 }, children: [
    active,
    " of the last ",
    window2,
    " days active"
...
function AnalyticsView() {
  const [scope, setScope] = reactExports.useState("day");
  const [anchor, setAnchor] = reactExports.useState(() => (/* @__PURE__ */ new Date()).toISOString().slice(0, 10));
  const [summary, setSummary] = reactExports.useState(null);
  const refresh = () => {
    void window.thread.invoke["analytics:scope"]({ scope, anchor }).then(setSummary);
  };
  reactExports.useEffect(refresh, [scope, anchor]);
  reactExports.useEffect(() => window.thread.on("analytics:changed", refresh), [scope, anchor]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "20px 28px 40px", maxWidth: 900, margin: "0 auto" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 12, marginBottom: 24 }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => shift(1), disabled: summary.atLatest, style: navBtn, children: "›" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 32, alignItems: "center", marginBottom: 28 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(MomentumRing, { value: summary.momentum, band: summary.band }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TrendChart, { trend: summary.trend }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ActiveDays, { active: summary.activeDays.active, window: summary.activeDays.window })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12, marginBottom: 20 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatTile, { label: "Sessions started", value: String(summary.sessionsStarted) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatTile, { label: "Focus time", value: formatDuration(summary.focusMs) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatTile, { label: "Threads completed", value: String(summary.threadsCompleted) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(InsightCard, { insight: summary.insight }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(DetailSection, { detail: summary.detail, scopeLabel: scope }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(DistractionSection, { stats: summary.distractions })
  ] });
}
function shiftLocal(scope, anchor, direction) {
  const [y2, m2, d2] = anchor.split("-").map(Number);
  const date2 = new Date(Date.UTC(y2, m2 - 1, d2));
  if (scope === "day") date2.setUTCDate(date2.getUTCDate() + direction);
  else if (scope === "week") date2.setUTCDate(date2.getUTCDate() + direction * 7);
  else date2.setUTCMonth(date2.getUTCMonth() + direction);
...
function ParkView() {
  const [thoughts, setThoughts] = reactExports.useState(null);
  const prevTab = useUiStore((s2) => s2.prevTab);
  const setTab = useUiStore((s2) => s2.setTab);
  const refresh = () => {
    void window.thread.invoke["park:all"](void 0).then(setThoughts);
  };
  reactExports.useEffect(refresh, []);
  reactExports.useEffect(() => window.thread.on("day:changed", refresh), []);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "20px 28px 40px", maxWidth: 820, margin: "0 auto" }, children: [
    ...
    thoughts === null ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "var(--text-muted)", fontSize: 13 }, children: "Loading…" }) : thoughts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      EmptyState,
      {
        title: "Nothing parked.",
        detail: "The Park button on the HUD and the Park box on the daily page both land here."
      }
    ) : groups.map((group) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 22 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          style: {
          ...
          children: formatLocalDate(group.date)
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: group.thoughts.map((thought) => /* @__PURE__ */ jsxRuntimeExports.jsx(ParkedCard, { thought }, thought.id)) })
    ] }, group.date))
  ] });
}
function ParkedCard({ thought }) {
  const [noting, setNoting] = reactExports.useState(false);
  const [note, setNote] = reactExports.useState(thought.note ?? "");
  reactExports.useEffect(() => {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "baseline", gap: 10 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { flex: 1, fontSize: 14 }, children: [
            thought.text,
            thought.processed ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 11, color: "var(--text-faint)", marginLeft: 8 }, children: "· promoted" }) : null
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 10, flexShrink: 0 }, children: [
            !thought.processed ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => act("todo"), style: action, title: "Turn into a to-do", children: "→ to-do" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => act("thread"), style: action, title: "Turn into a thread", children: "→ thread" })
            ] }) : null,
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: thought.note ? "edit note" : "+ note"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                onClick: () => void window.thread.invoke["thought:remove"]({
                  localDate: thought.localDate,
                  thoughtId: thought.id
                }),
        ...
        noting ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
            autoFocus: true,
            value: note,
        ...
        ) : thought.note ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
...
function groupByDate(thoughts) {
  ...
  for (const thought of thoughts) {
    const list = map2.get(thought.localDate);
    if (list) list.push(thought);
    else map2.set(thought.localDate, [thought]);
  }
...
function App() {
  ...
  const recovery = useSessionStore((s2) => s2.recovery);
  const setRecovery = useSessionStore((s2) => s2.setRecovery);
  reactExports.useEffect(() => {
    if (initialized) {
      setReady(true);
      return;
  ...
  if (!ready) return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: 24, color: "var(--text-muted)" }, children: "Loading…" });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    banner ? /* @__PURE__ */ jsxRuntimeExports.jsx(RepairBanner, { banner, onDismiss: () => setBanner(null) }) : null,
    recovery ? /* @__PURE__ */ jsxRuntimeExports.jsx(RecoveryPrompt, { offer: recovery, onDone: () => setRecovery(null) }) : null,
    /* @__PURE__ */ jsxRuntimeExports.jsx(Shell, {})
  ] });
}
function RepairBanner({ banner, onDismiss }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      style: {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: banner.message }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: onDismiss,
...
function RecoveryPrompt({ offer, onDone }) {
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { margin: "0 0 16px", fontSize: 15 }, children: [
              "You were on ‘",
              offer.threadTitle,
              "’ for ",
              formatDuration(offer.activeMs),
              " when the app closed. Count it?"
            ] }),
...
void window.thread.invoke["window:mainReady"](void 0);
