...
function EmptyState({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.root, children: [
...
const button = "_button_1tzqa_1";
const sm = "_sm_1tzqa_18";
const md = "_md_1tzqa_23";
const primary = "_primary_1tzqa_28";
const ghost = "_ghost_1tzqa_37";
const danger$1 = "_danger_1tzqa_46";
const styles$1 = {
  button,
  sm,
  md,
...
function Button({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      className: [styles$1.button, styles$1[variant], styles$1[size], className].filter(Boolean).join(" "),
      ...rest,
      children: [
        icon,
...
function ThreadPicker({
  ...
  const threads = useThreadStore((s2) => s2.threads).filter((t2) => t2.status !== "done");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 4, maxHeight: 220, overflowY: "auto" }, children: threads.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 12, color: "var(--text-faint)" }, children: "No open threads yet." }) : threads.map((thread) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
...
function PlanPanel({ day, readOnly }) {
  const threads = useThreadStore((s2) => s2.threads);
  const [picking, setPicking] = reactExports.useState(false);
  const intentThreads = threads.filter((t2) => day?.intentThreadIds.includes(t2.id));
  const toggleIntent = async (threadId) => {
...
function ThoughtRow({
  ...
  const process = async (action) => {
    setOpen(false);
    await window.thread.invoke["thought:process"]({ localDate: localDate2, thoughtId: thought.id, action });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
...
function ThoughtCapture({ day, readOnly }) {
  const [text, setText] = reactExports.useState("");
  const add2 = async () => {
    const trimmed = text.trim();
    setText("");
...
function TodayView() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "20px 28px 40px", maxWidth: 1040, margin: "0 auto" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 20 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ThoughtCapture, { day, readOnly: isPast }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(LoggedPanel, { day })
      ] })
    ] })
  ] });
}
...
function ThreadDetail({ thread, onClose }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "20px 28px 60px", maxWidth: 760, margin: "0 auto" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { style: { marginBottom: 28 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, { children: "Steps" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Checklist, { threadId: thread.id, steps: thread.steps })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { style: { marginBottom: 28 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, { children: "Notes" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "textarea",
        {
          value: notes,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, { children: "Sessions" }),
...
function StatTile({ label, value }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mono", style: { fontSize: 22 }, children: value }),
...
function DistractionSection({ stats }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: 8 }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 12, marginBottom: 16 }, children: [
